...
export const SmallTextFontFamily = "";
export const FooterFontFamily = "Poppines, sans-serif";

//backgrounds
export const DefaultBG = "#ffffff";
export const gradientBG = "linear-gradient(to right, #085d9e, #00c1de)";
export const GrayBG = "#F3F4F6";
//sanjay sir color1 : #009cde
//sanjay sir color2 : #00c1de
