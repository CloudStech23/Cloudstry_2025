...
import whychooseimg from "../../../assets/Images/DigCertPage/whychoose_bg.png";
...
function WhyChooseUs() {
  return (
    <div className="relative w-full z-10">
      ...
      <div
        className="w-full h-[500px] bg-no-repeat bg-cover bg-center relative flex items-center"
        style={{
      ...
      >
        ...
        <div className="w-full lg:w-full  flex flex-col    ">
          <div className=" w-full sm:w-[45%] p-6    ml-4 md:ml-4 ">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4
                  className="text-[20px] text-left font-semibold text-white"
                  style={{ fontFamily: HeadFontFamily }}
                >
                  Trusted Security
                </h4>
                <p className="text-white text-left w-full sm:w-full text-[14px] sm:text-[16.5px]">
          ...
          <div className="w-[45%] p-6    ml-4 md:ml-4 ">
            <div className="flex items-start gap-3">
              <div className="min-w-[48px] min-h-[48px] flex items-center justify-center rounded-full   text-sm font-semibold shadow-md ">
