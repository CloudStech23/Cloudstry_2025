...
function ContactSection() {
  return (
    <main className="pt-10 pb-16 px-4 mt-[1rem] sm:px-6 lg:px-8 bg-gradient-to-r from-[#085d9e] to-[#00c1de] rounded-tr-[80px] ">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 ">
        ...
        <div className="text-white text-center md:text-left">
          ...
          >
            Ready to get started? Contact us for expert Digital Certificate
            solution.
          </h2>
